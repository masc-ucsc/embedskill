...
def render_project_readme(board_id: str, output_name: str) -> str:
...
def main(argv: List[str]) -> int:
    ...
    context = install_skill.render_context(root, board_path, platform_path, args.output)
    install_skill.write_text(output_path, context)
    install_skill.write_text(readme_path, render_project_readme(board_id, args.output))
